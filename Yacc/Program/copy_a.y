%{
	...
	extern unsigned int lineCount, charCount;
	extern char* yytext;
...
class_declaration : class_modifiers CLASSs identifier super interfaces class_body
		  | class_modifiers CLASSs identifier class_body
		  | class_modifiers CLASSs identifier interfaces class_body
		  | class_modifiers CLASSs identifier super class_body
		  | CLASSs identifier super interfaces class_body
                  | CLASSs identifier class_body
                  | CLASSs identifier interfaces class_body
                  | CLASSs identifier super class_body
...
variable_declarator_id : identifier | variable_declarator_id LMBs RMBs
...
/*????????????????????為什麼method_modifiers不能recursive????????????????*/
...
method_declarator : identifier LSBs formal_parameter_list RSBs | identifier LSBs RSBs
...
array_initializer : LBBs variable_initializers COMMAs RBBs
...
labeled_statement : identifier COLONs statement
labeled_statement_no_short_if : identifier COLONs statement_no_short_if
...
break_statement : BREAKs identifier SEMICOLONs
continue_statement : CONTINUEs identifier SEMICOLONs
...
assignment_operator :  EQUALs | MULTIPLY_EQUALs | DEVIDE_EQUALs | MODULO_EQUALs | PLUS_EQUALs | MINUS_EQUALs | LL_EQUALs | RR_EQUALs  | RRR_EQUALs | UNIARY_AND_EQUALs | CARET_EQUALs | UNIARY_OR_EQUALs
...
method_invocation : method_name LSBs argument_list RSBs 
                  | primary DOTs identifier LSBs argument_list RSBs 
		  | SUPERs DOT identifier LSBs argument_list RSBs
...
type_name : identifier | package_name DOTs identifier
simple_type_name : identifier
expression_name : identifier | ambiguous_name DOTs identifier
method_name : identifier | PRINTs
...
hex_numeral : ZEROs X hex_digit | hex_numeral hex_digit
...
escape_character : BACKSLASHs LOWER_B | BACKSLASHs LOWER_F | BACKSLASHs LOWER_N | BACKSLASHs LOWER_T 		      | BACKSLASHs LOWER_R | BACKSLASHs BACKSLASH | BACKSLASHs DOUBLE_QUOTATIONs
null_literal : Nulls
identifier : IDs | other_IDs
